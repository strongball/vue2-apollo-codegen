...
export default class VueApolloVisitor extends ClientSideBaseVisitor<any, any> {
  ...
  private _buildMutation(node: OperationDefinitionNode, documentVariableName: string, operationType: string, operationResultType: string, operationVariablesTypes: string):string{
  ...
  private _buildQuery(node: OperationDefinitionNode, documentVariableName: string, operationType: string, operationResultType: string, operationVariablesTypes: string): string {
